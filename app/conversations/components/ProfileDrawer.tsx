              ...
              <div className='pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10'>
                ...
                >
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                    <div className='flex h-full flex-col overfow-y-scroll bg-white shadow-xl py-6'>
                      ...
                      <div className='relative flex-1 mt-6 px-4 sm:px-6'>
                        <div className='flex flex-col items-center'>
                          ...
                          <div className='text-sm text-gra-500 '>
                            {statusText}
                          </div>
                          ...
                          <div className='w-full py-5 sm:px-0 sm:pt-0'>
                            <dl className='space-y-8 px-4 sm:space-y-6 sm:px-6'>
                              {!data.isGroup && (
                                <div>
                                  <dt className='text-sm font-medium text-neutral-600 sm:w-40 sm:flex-shrink-0'>
                                    Email
                                  </dt>
